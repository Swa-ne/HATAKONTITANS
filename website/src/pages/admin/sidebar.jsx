...
const SideBar = ({ isClicked, onClick, onHover, onUnhover }) => {
    return (
        <div className={`sidebar-container ${isClicked ? "sidebar-open" : ""}`} onMouseOver={onHover} onMouseOut={onUnhover}>
            ...
            <ul className="iconS">
                <li>
                    <SideBarLink direct="/" title="Current Requests" icon={Current} isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct="/request-history" title="Request History" icon={History} isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct="/student-list" title="Student List" icon={Students} isClicked={isClicked} />
                </li>
            </ul>
            <Link
                to={"/"}
