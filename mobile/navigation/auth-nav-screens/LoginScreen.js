      ...
      <View style={styles.container}>
        <View style={styles.wFull}>
          <View style={styles.row}>
            <Image source={regtrack} style={styles.mr7} />
            <Text style={styles.brandName}>PAPER PULSE!</Text>
          </View>

          <Text style={styles.loginContinueTxt}>Welcome to PAPER PULSE!</Text>
          {/* <TextInput style={styles.input} onChangeText={handleUserIdentifierChange} placeholder='Email' /> */}
          <TextInput style={styles.input} placeholder="Email" />
          {/* <TextInput secureTextEntry={true} style={styles.input} onChangeText={handlePasswordChange} placeholder='Password' /> */}
          <TextInput
